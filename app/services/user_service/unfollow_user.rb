...
module UserService
  class UnfollowUser
    def call
      ...
      return [false, "you can't unfollow yourself", 422] if @current_user_id.eql?(@params["following_id"])

      ::FollowingsRepository::UnfollowUser.call(@params.merge!({"current_user_id" => @current_user_id}))
    end
